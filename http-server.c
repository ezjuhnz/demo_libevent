...
//./http-server -p 8000  -m 1024 -H 0.0.0.0 helloworld
//gcc http-server.c -o http-server -levent -I/usr/local/include -I /home/ezjuhnz/libevent/libevent-2.1.12-stable -Wl,-rpath=/usr/local/lib
...
{
	printf("dump_request_cb running...\n");
	const char *cmdtype;
